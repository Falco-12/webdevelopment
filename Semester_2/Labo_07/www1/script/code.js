...
const updateSize = () => {
	...
	speedX=window.innerWidth/(10000/UPDATE_DELAY); // 1x per seconde ganse breedte afleggen
	speedY=window.innerHeight/(10000/UPDATE_DELAY); // 1x per seconde ganse hoogte afleggen
}
